...
<template>
    <main
        ...
        class="min-h-screen flex justify-center px-[10px] items-center bg-lightGray dark:bg-lightGray-dark"
    >
        <section
            aria-label="login section"
            class="bg-barckground rounded-md dark:bg-barckground-dark w-[90%] sm:w-[70%] max-w-[500px] py-14 px-8 flex flex-col gap-y-4"
        >
